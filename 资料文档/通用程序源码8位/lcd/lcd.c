...
unsigned int  mode=1221;

//mode=1111_BOE24_ST7789V_并口_4线单通道
//mode=1211_BOE24_GC9306_并口_4线单通道

//mode=1121_CTC24_ST7789V_并口_4线单通道
//mode=1221_CTC24_GC9306_并口_4线单通道


///////////////////////////////////////

//mode=2111_BOE28_ST7789V_并口_4线单通道
//mode=2211_BOE28_GC9306_并口_4线单通道

//mode=2121_CTC28_ST7789V_并口_4线单通道
//mode=2221_CTC28_GC9306_并口_4线单通道

///////////////////////////////////////

//mode=1113_BOE24_ST7789V_3线2通道
//mode=1213_BOE24_GC9306_3线2通道
//mode=1123_CTC24_ST7789V_3线2通道
//mode=1223_CTC24_GC9306_3线2通道

///////////////////////////////////////

//mode=2113_BOE28_ST7789V_3线2通道
//mode=2213_BOE28_GC9306_3线2通道
//mode=2123_CTC28_ST7789V_3线2通道
//mode=2223_CTC28_GC9306_3线2通道
//----------------------------------------------------------------------
...
//---------------------------------ST7789SPowersetting--------------------------------------//
WriteComm(0xbb);
WriteData(0x30);//20改成30
WriteComm(0xc0);//增加了C0与C2寄存器
WriteData(0x2c);
WriteComm(0xc2);
WriteData(0x01);
WriteComm(0xc3);
WriteData(0x1a);//0B改与1A
WriteComm(0xc4);
WriteData(0x20);
WriteComm(0xc6);
WriteData(0x0f);
WriteComm(0xca);//增加CA/C8/55寄存器
WriteData(0x0f);
WriteComm(0xc8);
WriteData(0x08);
WriteComm(0x55);
